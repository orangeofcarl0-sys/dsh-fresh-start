...
export function apply(ctx) {
  ...
  ctx.effect(function* () {
    ...
    yield ctx.commands.register({
      name: 'fresh',
      description: 'Summarize this conversation, start a new one, and archive the old one (optional: /fresh <preset> to start the new session on a different agent preset)',
      handler,
    })
